...
const analyticsDashboard = read(
  "src/views/dashboard/analytics/modules/analytics-dashboard.vue",
);
assert.match(
  analyticsDashboard,
...
const financialReport = read(
  "src/views/dashboard/analytics/modules/financial-report.vue",
);
assert.doesNotMatch(
  financialReport,
...
const expenseManagement = read(
  "src/views/dashboard/analytics/modules/expense-management.vue",
);
assert.doesNotMatch(
  expenseManagement,
...
const migrationExtensions = read(
  "../AnhEmMotor-Backend/WebAPI/Extensions/MigrationExtensions.cs",
);
assert.match(
  migrationExtensions,
