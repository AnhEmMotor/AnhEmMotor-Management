...
const customerCrmPath = resolve(projectRoot, 'src/modules/Marketing/constants/customerCrm.ts');
...
for (const status of leadStatuses) {
  assert.match(customerCrmSource, new RegExp(`["']${status}["']`), `Missing lead status ${status}`);
}
