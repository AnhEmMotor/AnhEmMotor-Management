...
const listSource = read('../src/modules/Admin/view/contract/supplier/index.vue');
const detailSource = read('../src/modules/Admin/view/contract/supplier/contract-preview.vue');
...
assert.ok(
  listSource.indexOf('prop: "contractNumber"') < listSource.indexOf('prop: "supplierName"'),
