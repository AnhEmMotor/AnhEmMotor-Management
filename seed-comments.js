const comments = [
  ...
  },
  {
    ...
    authorName: "Hải Yến",
    content:
      "Đã qua xem xe và chốt luôn con Vario 160. Giá rất tốt so với mặt bằng chung.",
  },
  {
    articleType: "promotion",
    ...
    content:
      "Thủ tục trả góp cần chuẩn bị những giấy tờ gì ạ? Mình muốn mua SH.",
  },
  {
    articleType: "promotion",
    articleSlug: "tra-gop-0-phan-tram-so-huu-xe-sang",
  ...
  },
  {
    ...
    content:
      "Xe Vision 2020 cũ đổi sang Air Blade 2024 thì bù tầm bao nhiêu vậy?",
  },
  {
    articleType: "promotion",
    articleSlug: "doi-cu-lay-moi-gia-tri-toi-da",
  ...
  },
  {
    ...
    content:
      "Quà tặng giao xe đợt này là gì vậy ad? Có voucher sửa chữa không?",
  },
  {
  ...
  },
  {
    ...
    content:
      "Bài viết rất dễ hiểu. Bây giờ mình mới phân biệt được ABS và CBS.",
  },
  {
    newsId: 21,
  ...
  for (const c of comments) {
    ...
    try {
      const res = await fetch(
        "http://localhost:5000/api/v1/news-comments/public",
        {
          method: "POST",
