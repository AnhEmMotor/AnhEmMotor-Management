    ...
    <div class="art-card-header mb-6">
      <div class="title">
        <h4 class="text-lg font-bold text-gray-800"
          >Biểu đồ so sánh doanh thu và chi phí theo từng tháng</h4
        >
        <p class="text-sm text-gray-500 mt-1">
          Lợi nhuận ròng tăng trưởng <span class="text-success font-semibold">+15%</span> trong năm
          nay
        </p>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const revenueData = [120, 150, 180, 200, 250, 210, 190, 230, 260, 280, 310, 350] // Tỷ đồng
