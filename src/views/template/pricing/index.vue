<template>
  <div class="pt-24 px-20 max-md:!pt-15 max-sm:!px-5 max-md:!px-8 bg-transparent !border-none">
    <div class="mb-10 text-center">
      <h1 class="mb-2 text-4xl font-medium max-sm:text-3xl">{{ $t('admin.t221') }}</h1>
          ...
          <ElCard class="flex flex-col h-full rounded-xl">
            <div class="mb-5">
              ...
              <div class="mt-7.5">
                ...
                <span class="ml-2.5 text-sm text-g-600">{{ $t('admin.t225') }}</span>
              </div>
            </div>
...
<script setup lang="ts">
  ...
  const pricingPlans = ref<PricingPlan[]>([
    {
      type: 'single',
      title: 'đơnlầnkhiếndùngbản',
      description: 'thíchdùngởđơnchiếcnhấtcuốisinhsản phẩm，nhấtcuốiNguoiDungvôcầntrảphí。',
      price: 349,
      features: [
        { text: 'Đầy đủnguồnđạimã', available: true },
        { text: 'kỹthuậtTaiLieu', available: true },
    ...
    {
      type: 'multiple',
      title: 'đalầnkhiếndùngbản',
      description: 'thíchdùngởvôhạnchiếcnhấtcuốisinhsản phẩm，nhấtcuốiNguoiDungvôcầntrảphí。',
      price: 629,
      features: [
        { text: 'Đầy đủnguồnđạimã', available: true },
        { text: 'kỹthuậtTaiLieu', available: true },
    ...
    {
      type: 'extended',
      title: 'mởtriểntraoquyềnbản',
      description: 'thíchdùngởđơnchiếcnhấtcuốisinhsản phẩm，nhấtcuốiNguoiDungcầncầntrảphí。',
      price: 2099,
      features: [
        { text: 'Đầy đủnguồnđạimã', available: true },
        { text: 'kỹthuậtTaiLieu', available: true },
    ...
    {
      type: 'unlimited',
      title: 'vôhạntraoquyềnbản',
      description: 'thíchdùngởvôhạnchiếcnhấtcuốisinhsản phẩm，nhấtcuốiNguoiDungcầncầntrảphí。',
      price: 3499,
      features: [
        { text: 'Đầy đủnguồnđạimã', available: true },
        { text: 'kỹthuậtTaiLieu', available: true },
