        ...
        <ElCard class="reporting-card editor-card flex flex-col">
          <template #header>
            <div class="flex justify-between items-center">
              <span
                class="text-[10px] font-black text-slate-800 uppercase tracking-widest"
              >
...
:global(
  .contract-editor .w-e-text-container .w-e-scroll::-webkit-scrollbar-track
) {
  background: transparent;
}

:global(
  .contract-editor .w-e-text-container .w-e-scroll::-webkit-scrollbar-thumb
) {
...
:global(
  .contract-editor .w-e-text-container [data-slate-editor] .token-jump-flash
) {
  border-radius: 4px;
...
:global(
  .contract-editor .w-e-text-container [data-slate-editor] table:first-child
) {
  margin-bottom: 12px !important;
}

:global(
  .contract-editor .w-e-text-container [data-slate-editor] table:first-child td
) {
  width: 50% !important;
...
:global(
  .contract-editor .w-e-text-container [data-slate-editor] table:last-child
) {
  margin-top: 24px !important;
}

:global(
  .contract-editor .w-e-text-container [data-slate-editor] table:last-child td
) {
  width: 50% !important;
  text-align: center !important;
  border: 0 !important;
...
:global(
  html.dark .contract-editor .w-e-toolbar .w-e-bar-item.w-e-bar-item--active
) {
...
:global(
  html.dark .contract-editor .w-e-text-container > div[data-placeholder]
) {
  color: #f8fafc !important;
}
