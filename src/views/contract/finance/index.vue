    ...
    <ElCard class="flex-1 art-table-card">
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          ...
          <ElButton type="primary" v-ripple @click="exportToExcel">
      ...
      >
        ...
        <template #cavetLocation="{ row }">
          <div class="flex flex-col items-start gap-1">
            ...
            <ElBadge v-if="row.cavetActionRequired" is-dot class="item" type="warning">
        ...
        <!-- 4. Các "Quy trình thép" tích hợp thẳng vào UI Thao tác -->
          ...
          <div class="flex items-center justify-between gap-2" style="min-width: 220px;">
            <div class="flex items-center">
              <ArtButtonTable type="view" variant="ghost" @click="goToPreview(row.id)" />
              <ArtButtonTable type="edit" variant="ghost" @click="goToPreview(row.id)" />
            </div>
