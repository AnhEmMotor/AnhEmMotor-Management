...
<template>
  <div class="pb-5">
    ...
    >
      <template #slots>
        <ElInput v-model="formDataAdvanced.slots" :placeholder="$t('admin.t82')" />
      </template>
    </ArtSearchBar>
    ...
    <div class="mt-3.5">
      ...
      <ElSpace wrap>
        ...
        <ElButton @click="labelWidthAdvanced = 120"> sửasửa label Chiều rộng </ElButton>
        <ElButton @click="spanAdvanced = 8"> CaiDatmộtdòngHiển thịcủaComponentsố </ElButton>
        <ElButton @click="gutterAdvanced = 50"> sửasửa gutter </ElButton>
        <ElButton @click="labelPositionAdvanced = 'left'"> label tráiđốicăn </ElButton>
        <ElButton @click="labelPositionAdvanced = 'right'"> label phảiđốicăn </ElButton>
        <ElButton @click="labelPositionAdvanced = 'top'"> label Phía trênđốicăn </ElButton>
      </ElSpace>
    </div>
  </div>
</template>
