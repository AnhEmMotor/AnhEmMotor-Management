      ...
      <table class="pnl-table">
        ...
        <tbody>
          ...
          <tr class="pnl-row pnl-row--income">
            ...
            <td class="p-4 text-right">{{ formatCurrency(displayReport.totalRevenue) }}</td>
          </tr>
          <tr class="pnl-row">
          ...
          <tr class="pnl-row pnl-row--cost">
            ...
            <td class="p-4 text-right">{{ formatCurrency(displayReport.totalCostOfGoodsSold) }}</td>
          </tr>

          <!-- Lợi nhuận gộp -->
          <tr class="pnl-row pnl-row--gross">
            <td class="p-4 text-lg">LỢI NHUẬN GỘP</td>
            <td class="p-4 text-right text-lg">{{ formatCurrency(displayReport.grossProfit) }}</td>
          </tr>
          ...
          <tr class="pnl-row pnl-row--net">
            ...
            <td class="p-4 text-right">{{ formatCurrency(displayReport.netProfit) }}</td>
          </tr>
        </tbody>
      </table>
    </div>
