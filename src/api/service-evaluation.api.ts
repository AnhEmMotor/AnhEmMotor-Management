...
import type { EvaluationDetail, EvaluationListItem } from '@/domain/evaluation/types'
...
export const ServiceEvaluationApi = {
  ...
  createReply(data: { evaluationId: number; message: string; markAsProcessed: boolean }) {
