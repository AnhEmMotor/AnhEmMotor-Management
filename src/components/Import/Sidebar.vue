...
<template>
  <div
    class="w-60 bg-white border-r border-gray-200 p-3 flex-shrink-0 custom-scroll overflow-y-auto"
  >
    <!-- Nhóm trạng thái -->
    <div class="mb-4">
      ...
      <ul class="space-y-1 text-xs text-gray-700">
        <li class="flex items-center space-x-2">
          <input
            type="checkbox"
            id="status-draft"
            v-model="localFilters['Phiếu tạm']"
        ...
        <li class="flex items-center space-x-2">
          <input
            type="checkbox"
            id="status-received"
            v-model="localFilters['Đã nhập hàng']"
            class="status-filter w-3 h-3 rounded text-red-600 focus:ring-red-500"
          />
      ...
      <div class="relative text-xs text-gray-700">
        ...
        >
          <div class="grid grid-cols-5 gap-2 text-center">
            ...
            <button class="time-option p-1 rounded hover:bg-gray-100" @click="selectTimeOption">
              Hôm nay
            </button>
            <button class="time-option p-1 rounded hover:bg-gray-100" @click="selectTimeOption">
              Tuần này
            </button>
            <button class="time-option p-1 rounded bg-red-600 text-white" @click="selectTimeOption">
              Tháng này
            </button>
            <button class="time-option p-1 rounded hover:bg-gray-100" @click="selectTimeOption">
              Quý này
