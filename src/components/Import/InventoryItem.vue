...
<template>
  ...
  >
    <!-- Dòng tóm tắt phiếu -->
    <div
      class="summary-row grid summary-row-grid items-center py-2 px-3 text-sm cursor-pointer transition duration-150"
    ...
    >
      ...
      <!-- Cần trả NCC -->
      <div class="px-3 text-gray-600 text-right text-sm amount-payable">
