...
<template>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-shrink-0 bg-white border-b border-gray-200 px-6 pt-3">
            <div class="grid summary-row-grid text-xs text-gray-500 font-medium whitespace-nowrap overflow-x-auto custom-scroll">
                <div class="pb-2 px-3"></div> <!-- Cột rỗng cho Checkbox -->
                <div class="pb-2 px-3 border-b-2 border-red-600 text-red-600 cursor-pointer">Mã nhập hàng</div>
        ...
        <footer class="flex-shrink-0 bg-white border-t border-gray-200 py-2 px-4 flex justify-between items-center shadow-inner">
