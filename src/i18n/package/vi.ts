export default {
  httpMsg: {
    ...
    methodNotAllowed: 'Phương thức HTTP mà request yêu cầu không có trong hệ thống ',
  ...
  menus: {
    ...
    hr: {
      ...
      kpiManagement: {
        eyebrow: 'Hiệu suất đội ngũ',
        title: 'Quản lý KPI nhân viên',
        subtitle:
          'Thiết lập mục tiêu, cập nhật kết quả và theo dõi mức độ hoàn thành theo từng kỳ.',
        add: 'Thêm KPI',
        refresh: 'Làm mới',
        summary: {
          total: 'Tổng KPI',
          met: 'Đạt hoặc vượt',
          near: 'Sắp đạt',
          average: 'Tiến độ trung bình',
        },
        filter: {
          keyword: 'Tìm nhân viên hoặc tên KPI',
          employee: 'Tất cả nhân viên',
          status: 'Tất cả trạng thái',
          period: 'Lọc theo kỳ đánh giá',
          reset: 'Đặt lại',
        },
        status: {
          met: 'Đạt KPI',
        ...
        form: {
          createTitle: 'Thiết lập KPI mới',
          editTitle: 'Cập nhật KPI',
          viewTitle: 'Chi tiết KPI',
          employee: 'Nhân viên',
          employeePlaceholder: 'Chọn nhân viên',
          metric: 'Tên chỉ số KPI',
          metricPlaceholder: 'Ví dụ: Doanh số xe trong tháng',
          periodStart: 'Ngày bắt đầu',
          periodEnd: 'Ngày kết thúc',
          target: 'Giá trị mục tiêu',
          actual: 'Giá trị thực tế',
          description: 'Mô tả và tiêu chí đánh giá',
          descriptionPlaceholder: 'Ghi rõ cách đo lường hoặc lưu ý cho kỳ KPI',
        },
        validation: {
          employee: 'Vui lòng chọn nhân viên',
          metric: 'Vui lòng nhập tên chỉ số KPI',
          target: 'Mục tiêu phải lớn hơn 0',
          actual: 'Giá trị thực tế không được âm',
          periodStart: 'Vui lòng chọn ngày bắt đầu',
          periodEnd: 'Vui lòng chọn ngày kết thúc',
          periodOrder: 'Ngày kết thúc phải từ ngày bắt đầu trở đi',
        },
        message: {
          loadError: 'Không thể tải danh sách KPI',
          employeeLoadError: 'Không thể tải danh sách nhân viên',
          created: 'Đã thêm KPI mới',
          updated: 'Đã cập nhật KPI',
          deleted: 'Đã xóa KPI',
          saveError: 'Không thể lưu KPI',
          deleteError: 'Không thể xóa KPI',
          deleteConfirm: 'Xóa KPI “{name}” của {employee}?',
          deleteTitle: 'Xác nhận xóa KPI',
        },
        empty: {
          title: 'Chưa có KPI phù hợp',
          description: 'Thay đổi bộ lọc hoặc tạo KPI đầu tiên cho nhân viên.',
        },
      },
    },
    service: {
  ...
  logistics: {
    ...
    fulfillment: {
      ...
      alerts: {
        ...
        pickingIncomplete: 'Vui lòng chọn nhặt đầy đủ các mặt hàng trước khi bắt đầu đóng gói.',
      },
      table: {
        image: 'Hình ảnh',
    ...
    tracking: {
      ...
      paid: 'ĐÃ THANH TOÁN',
      stuckAlert: 'Cảnh báo: Kiện hàng có vẻ đang bị kẹt tại bưu cục hơn 48 giờ!',
    },
  },
};
