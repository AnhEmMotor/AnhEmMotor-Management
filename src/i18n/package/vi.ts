export default {
  httpMsg: {
    ...
    methodNotAllowed:
      "Phương thức HTTP mà request yêu cầu không có trong hệ thống ",
  ...
  menus: {
    logistics: {
      ...
      fulfillment: "Đóng gói & Bàn giao",
      tracking: "Tra cứu hành trình",
      returns: "Quản lý hàng hoàn",
      carrierSettings: "Cấu hình đối tác",
    },
    inventory: {
    ...
    contract: {
      ...
      templateCreateTitle: "Tạo mẫu hợp đồng",
      templateEditTitle: "Biên tập mẫu hợp đồng",
      templateEditorDescription:
        "Chỉnh sửa nội dung mẫu, chèn biến động và kiểm tra bản in hợp đồng trước khi lưu.",
      templateClone: "Nhân bản tạo phiên bản mới",
      templateDelete: "Xóa mẫu hợp đồng",
      templateImport: "Nhập file Word",
    ...
    contact: {
      ...
      cvViewer: {
        ...
        noFile: "Không có file CV",
        download: "Tải CV",
      },
      assignDialog: {
        title: "Phân công xử lý",
        selectUser: "Chọn nhân viên phụ trách",
      },
      createDialog: {
  ...
  marketing: {
    bannerManagement: {
      ...
      createBtn: "Tạo banner",
      editBtn: "Sửa banner",
      pc: "PC",
      mb: "MB",
      createTitle: "Tạo banner mới",
      editTitle: "Chỉnh sửa banner",
      formTitle: "Tiêu đề banner",
      formPlacement: "Vị trí hiển thị (Placement)",
      formDesc: "Mô tả banner",
      formCtaLabel: "Nút bấm (CTA Label)",
      formCtaLink: "Đường dẫn đích (CTA Link)",
      formDesktopImg: "Ảnh Desktop (Tỷ lệ 21:9)",
      formMobileImg: "Ảnh Mobile (Tỷ lệ 4:5 hoặc 1:1)",
      closeBtn: "Đóng",
      saveBtn: "Lưu thay đổi",
      createSubmitBtn: "Tạo banner",
    },
    comment: {
      title: "Quản lý Bình luận",
      subtitle: "Quản lý tất cả bình luận từ khách hàng",
      detailTitle: "Chi tiết bình luận",
      replyTitle: "Trả lời bình luận",
    },
    conversionTools: {
      title: "Công cụ Chuyển đổi (Conversion)",
      subtitle: "Pop-up & Landing Page: Chốt sale tự động",
      tabPopup: "Quản lý Pop-up",
      tabLanding: "Landing Page Builder",
      popupListTitle: "Danh sách Pop-up hoạt động",
      createPopupBtn: "Tạo Pop-up mới",
      landingListTitle: "Trang đích & Chiến dịch sản phẩm",
      createLandingBtn: "Xây dựng trang mới",
      showAfter: "Hiện sau",
      page: "Trang",
      views: "Hiển thị",
      clicks: "Click",
      editBtn: "Sửa",
      viewPageBtn: "Xem trang",
      leads: "Leads",
    },
    customer: {
      title: "Quản lý Khách hàng",
      subtitle: "Quản lý thông tin và hoạt động của khách hàng",
      potential: "Khách hàng tiềm năng",
      potentialDesc: "Quản lý leads và khách hàng tiềm năng",
      profile: "Hồ sơ khách hàng",
      profileDesc: "Xem và chỉnh sửa hồ sơ khách hàng",
      asset: "Tài sản",
      assetDesc: "Quản lý tài sản của khách hàng",
      care: "Chăm sóc",
  ...
  logistics: {
    ...
    fulfillment: {
      ...
      actions: {
        ...
        markReturned: "Xác nhận đã trả hàng",
      },
      alerts: {
        restricted:
          "CẢNH BÁO: Đơn hàng chứa Xe máy hoặc hàng hạn chế. Bắt buộc dùng đội xe nội bộ!",
        outOfStock:
          "CẢNH BÁO: Thiếu tồn kho cho một số mặt hàng. Vui lòng xác minh trước khi đóng gói!",
        pickingIncomplete:
          "Vui lòng chọn nhặt đầy đủ các mặt hàng trước khi bắt đầu đóng gói.",
      },
      table: {
        image: "Hình ảnh",
    ...
    tracking: {
      title: "Bản đồ theo dõi vận chuyển",
      searchPlaceholder: "Tìm kiếm bằng SĐT, mã đơn hàng, mã vận đơn...",
      filterCarrier: "Tất cả nhà vận chuyển",
      ...
      carrier: "Đối tác:",
      cod: "COD:",
      itemsCount: "Xem {count} sản phẩm",
      timelineTitle: "Lịch trình vận chuyển",
      paid: "ĐÃ THANH TOÁN",
      stuckAlert:
        "Cảnh báo: Kiện hàng có vẻ đang bị kẹt tại bưu cục hơn 48 giờ!",
    },
  },
};
