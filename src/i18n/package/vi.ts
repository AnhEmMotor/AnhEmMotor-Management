export default {
  ...
  logistics: {
    dashboard: {
      ...
      thisMonth: 'Tháng này',
      thisYear: 'Năm nay',
      fulfillmentWorkload: 'Khối lượng công việc',
      pendingCod: 'Dòng tiền COD chờ đối soát',
      otifRate: 'Tỷ lệ đúng hạn (OTIF)',
      returnsClaimsRatio: 'Tỷ lệ Hoàn/Bom hàng',
      fulfillmentFunnel: 'Phễu Vận Chuyển',
      funnelPlaceholder: 'Đang tải dữ liệu biểu đồ Phễu...',
      productionShippingCost: 'Chi phí Giao hàng & Sản xuất',
      costPlaceholder: 'Đang tải dữ liệu biểu đồ chi phí...',
      carrierScorecard: 'Hiệu suất Đối tác Vận chuyển',
      refresh: 'Làm mới',
      carrier: 'Đơn vị Vận chuyển',
      deliveredCount: 'Số đơn đã giao',
      avgDeliveryDays: 'Thời gian giao TB (ngày)',
      avgShippingCostPerOrder: 'Phí ship TB / Đơn',
      returnsRatio: 'Tỷ lệ hoàn',
      exceptionsLog: 'Cảnh báo Sự cố Khẩn cấp',
      items: 'mục',
      noExceptions: 'Không có sự cố bất thường nào.',
      type: 'Loại sự cố',
      tracking: 'Mã vận đơn',
      message: 'Nội dung',
      createdAt: 'Thời gian',
    ...
    fulfillment: {
      title: 'Xử lý đơn giao',
      pickingList: 'Danh sách nhặt hàng (Picking List)',
      dispatchPanel: 'Thông tin Giao hàng & Vận đơn',
      orderId: 'Mã đơn giao',
      ...
      inputTracking: 'Nhập mã vận đơn...',
      actions: {
        startPacking: 'Bắt đầu đóng gói',
        exportWarehouse: 'Xuất kho & Giao ĐVVC',
        markCompleted: 'Đánh dấu Hoàn thành',
        markReturned: 'Đánh dấu Hàng Hoàn',
      },
      alerts: {
        restricted:
          'CẢNH BÁO: Đơn hàng chứa Xe máy hoặc mặt hàng cấm gửi bưu cục. Cần sử dụng đội xe giao hàng nội bộ!',
        outOfStock:
          'CẢNH BÁO: Có mặt hàng thiếu tồn kho. Vui lòng kiểm tra lại trước khi đóng gói!',
        pickingIncomplete: 'Vui lòng nhặt đủ hàng (đánh dấu tất cả) trước khi xuất kho.',
      },
      table: {
        image: 'Ảnh',
      ...
      tracking: {
        title: 'Tra cứu hành trình kiện hàng',
        searchPlaceholder: 'Tìm kiếm theo SĐT, Mã đơn, Mã vận đơn...',
        filterCarrier: 'Tất cả ĐVVC',
        ...
        carrier: 'ĐVVC:',
        cod: 'COD:',
        itemsCount: 'Xem {count} Phụ tùng',
        timelineTitle: 'Trục mốc thời gian',
        paid: 'ĐÃ THANH TOÁN',
        stuckAlert: 'Cảnh báo: Kiện hàng có dấu hiệu kẹt tại bưu cục quá 48h!',
      },
    },
  },
}
