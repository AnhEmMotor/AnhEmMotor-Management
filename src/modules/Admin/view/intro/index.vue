<template>
  <div class="banner-container">
    <div class="banner-image">
      <img src="@/assets/images/banner/admin_banner.png" alt="Admin Banner" />
    </div>
      ...
      <div class="info-card">
        ...
        <div class="contact-grid">
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:mail-line" class="icon-rose" />
            </div>
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:phone-line" class="icon-rose" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:chat-3-line" class="icon-rose" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:facebook-circle-line" class="icon-rose" />
            </div>
            <div class="box-content">
      ...
      <div class="info-card">
        ...
        <div class="action-buttons">
          <div class="action-btn btn-dark">
            <div class="btn-icon"><ArtSvgIcon icon="ri:settings-4-line" /></div>
            <div class="btn-text">
              <span class="btn-title">CẤU HÌNH HỆ THỐNG</span>
        ...
        <div class="tags-section">
          ...
          <div class="tags-list">
            ...
            <span class="tag">PHÂN QUYỀN</span>
            <span class="tag">NHÂN SỰ</span>
            <span class="tag">QUẢN TRỊ RỦI RO</span>
            <span class="tag">CHÍNH SÁCH BÁN HÀNG</span>
          </div>
        </div>
      </div>
    </div>
...
.contact-box {
  ...
  &:hover {
    box-shadow: 0 2px 8px rgb(225 29 72 / 15%);
  }
