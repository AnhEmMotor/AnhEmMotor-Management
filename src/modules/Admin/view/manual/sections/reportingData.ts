  ...
  pages: [
    {
      ...
      description: "Bảng điều khiển (Dashboard) tổng hợp các chỉ số kinh doanh then chốt của toàn công ty.",
      steps: [
    ...
    },
    {
      ...
      description: "Theo dõi dòng tiền thu-chi, biến động lợi nhuận và tỷ suất hoàn vốn (ROI).",
      steps: [
    ...
    },
    {
      ...
      description: "Thống kê lượng xuất-nhập-tồn, đánh giá giá trị hàng hóa và nhận cảnh báo sắp hết hàng.",
      steps: [
    ...
    },
    {
      ...
      description: "Theo dõi hoạt động sửa chữa, bảo hành và tiền công thợ của các xưởng dịch vụ.",
      steps: [
