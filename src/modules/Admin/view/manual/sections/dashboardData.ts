...
export const sectionData: GuideSection = {
  ...
  subtitle: 'Dashboard',
  description: 'Trang tổng quan hệ thống cung cấp góc nhìn toàn diện cho Ban Giám Đốc về tình hình hoạt động của toàn bộ các chi nhánh, nhân sự, và tình hình kinh doanh.',
  icon: DataAnalysis,
  color: '#0284c7',
  ...
  pages: [
    {
      ...
      description: 'Trang thông tin tổng quát khi Admin mới đăng nhập vào hệ thống.',
      steps: [
    ...
    },
    {
      ...
      description: 'Báo cáo tổng hợp số lượng khách hàng, nhân sự và các chỉ số hoạt động.',
      steps: [
    ...
    },
    {
      ...
      description: 'Bảng điều khiển chuyên sâu về doanh thu bán hàng và lợi nhuận.',
      steps: [
