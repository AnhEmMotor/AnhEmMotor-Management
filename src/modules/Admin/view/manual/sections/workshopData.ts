  ...
  pages: [
    {
      ...
      description:
        "Xem các chỉ số KPI, hiệu suất làm việc của thợ và doanh thu dịch vụ tổng hợp.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Theo dõi toàn bộ các phiếu sửa chữa, bảo dưỡng đã và đang được xử lý trên hệ thống.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Giám sát quy trình xử lý bảo hành, thay thế phụ tùng lỗi từ nhà sản xuất.",
      steps: [
