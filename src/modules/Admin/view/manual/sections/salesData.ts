...
export const sectionData: GuideSection = {
  ...
  description: 'Giao diện giám sát toàn bộ hoạt động bán hàng: Hóa đơn, hoàn trả và báo cáo doanh số tổng hợp.',
  icon: Money,
  color: '#059669',
  ...
  pages: [
    {
      ...
      description: 'Giám sát và phê duyệt các yêu cầu hủy đơn hoặc trả lại xe từ khách hàng.',
      steps: [
    ...
    },
    {
      ...
      description: 'Công cụ giám sát toàn bộ hóa đơn đã được lập tại tất cả showroom.',
      steps: [
    ...
    },
    {
      ...
      description: 'Trích xuất báo cáo doanh số, số lượng xe bán ra theo nhiều tiêu chí.',
      steps: [
