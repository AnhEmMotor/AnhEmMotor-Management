  ...
  pages: [
    {
      ...
      description: "Quản lý và tra cứu toàn bộ hợp đồng mua bán xe máy trên toàn hệ thống.",
      steps: [
    ...
    },
    {
      ...
      description: "Quản lý các bản cam kết và hợp đồng với đối tác cung cấp xe máy, phụ tùng.",
      steps: [
    ...
    },
    {
      ...
      description: "Quy trình số hóa giúp Ban Giám Đốc xét duyệt nhanh các hợp đồng được gửi lên.",
      steps: [
