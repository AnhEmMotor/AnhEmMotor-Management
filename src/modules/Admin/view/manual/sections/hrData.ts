  ...
  pages: [
    {
      ...
      description: "Xem và quản lý hồ sơ, chức vụ, phòng ban và phân công chi nhánh của toàn bộ nhân sự.",
      steps: [
    ...
    },
    {
      ...
      route: "/admin/policy",
      description: "Cấu hình linh hoạt các chính sách thưởng, hoa hồng theo từng loại hình công việc.",
      steps: [
    ...
    },
    {
      ...
      route: "/admin/payroll",
      description: "Tự động tổng hợp và tính toán lương thưởng, phạt, hoa hồng cuối tháng.",
      steps: [
