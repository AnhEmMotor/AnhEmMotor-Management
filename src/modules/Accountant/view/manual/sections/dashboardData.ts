export const sectionData = {
  ...
  description: "Báo cáo tổng hợp số liệu dành cho quản lý cấp cao.",
  pages: [
    {
      id: "executive-dashboard",
      title: "Tổng quan điều hành",
      description: "Hiển thị các biểu đồ và chỉ số KPI quan trọng nhất.",
      route: "/Accountant/executive-dashboard",
      steps: [
