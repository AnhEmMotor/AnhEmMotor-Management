      ...
      <div class="info-card">
        ...
        <div class="contact-grid">
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:mail-line" class="icon-orange" />
            </div>
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:phone-line" class="icon-orange" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:chat-3-line" class="icon-orange" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:facebook-circle-line" class="icon-orange" />
            </div>
            <div class="box-content">
      ...
      <div class="info-card">
        ...
        <div class="action-buttons">
          <div class="action-btn btn-dark">
            ...
            <div class="btn-text">
              <span class="btn-title">QUẢN LÝ ĐƠN HÀNG</span>
          ...
          <div class="action-btn btn-light">
            <div class="btn-icon text-orange">
        ...
        <div class="tags-section">
          ...
          <div class="tags-list">
            <span class="tag">ĐƠN HÀNG ONLINE</span>
            <span class="tag">ĐƠN BÁN LẺ</span>
            <span class="tag">BÁO GIÁ DỊCH VỤ</span>
            <span class="tag">XỬ LÝ THANH TOÁN</span>
            <span class="tag">TRA CỨU DOANH THU</span>
          </div>
        </div>
      </div>
    </div>
