      ...
      <el-card shadow="hover" class="kpi-card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <div class="text-xs text-gray-400 mt-1">Đang hoàn thiện nội dung</div>
          </div>
      ...
      <el-card shadow="hover" class="kpi-card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <div class="text-xs text-gray-400 mt-1">Đã gửi, tạm khóa chỉnh sửa</div>
          </div>
...
const formatVehicleTransaction = (contract: SalesContractListDto): string => {
  const details = [contract.vehicleModel, contract.vehicleVersion, contract.vehicleColor].filter(
