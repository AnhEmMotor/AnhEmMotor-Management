      ...
      <div class="info-card">
        ...
        <div class="contact-grid">
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:mail-line" class="icon-blue" />
            </div>
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:phone-line" class="icon-blue" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:chat-3-line" class="icon-blue" />
            </div>
            <div class="box-content">
          ...
          <div class="contact-box">
            <div class="box-icon">
              <ArtSvgIcon icon="ri:facebook-circle-line" class="icon-blue" />
            </div>
            <div class="box-content">
      ...
      <div class="info-card">
        ...
        <div class="action-buttons">
          <div class="action-btn btn-dark">
            <div class="btn-icon"><ArtSvgIcon icon="ri:megaphone-line" /></div>
            <div class="btn-text">
              <span class="btn-title">CÔNG CỤ MARKETING</span>
        ...
        <div class="tags-section">
          ...
          <div class="tags-list">
            <span class="tag">QUẢN LÝ BÀI VIẾT</span>
            <span class="tag">CHIẾN DỊCH QUẢNG CÁO</span>
            <span class="tag">HỒ SƠ KHÁCH HÀNG 360</span>
            <span class="tag">CHĂM SÓC TỰ ĐỘNG</span>
            <span class="tag">QUẢN LÝ VOUCHER</span>
          </div>
        </div>
      </div>
    </div>
...
.contact-box {
  ...
  &:hover {
    box-shadow: 0 2px 8px rgb(37 99 235 / 15%);
  }
