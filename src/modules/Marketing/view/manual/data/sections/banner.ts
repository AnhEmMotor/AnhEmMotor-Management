  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Nhấn nút <b>+ Thêm Mới</b> để tạo một banner mới.<br><img src='https://placehold.co/600x300/e2e8f0/1e293b?text=Them+Banner+Moi' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
