  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Nhấn nút <b>+ Thêm Mới</b> để tạo một banner mới.<br><img src='/api/v1/MediaFile/view-image/manuals/banner-list-step-1.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
