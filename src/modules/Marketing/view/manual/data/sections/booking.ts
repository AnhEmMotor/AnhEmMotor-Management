  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Sau khi xác nhận, chuyển trạng thái thành <b>Đã xác nhận</b>.<br><img src='/api/v1/MediaFile/view-image/manuals/booking-manage-step-2.png' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
