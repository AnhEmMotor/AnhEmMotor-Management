  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Cập nhật trạng thái cơ hội (Mới, Đã liên hệ, Đang tư vấn, Thành công, Thất bại) tùy theo tiến trình thực tế.<br><img src='/api/v1/MediaFile/view-image/manuals/customer-potential-step-3.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Theo dõi <b>Dòng thời gian tương tác (Timeline)</b> ở cột giữa ghi nhận log chatbot, ghi chú sale, và dấu mốc showroom.<br><img src='/api/v1/MediaFile/view-image/manuals/customer-profile-360-step-3.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Khai báo chính xác các thông tin: Số khung, Số máy, Biển số xe, Ngày mua và thời hạn đăng kiểm/bảo hiểm.<br><img src='/api/v1/MediaFile/view-image/manuals/customer-asset-step-2.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Tại sidebar <b>Nhắc lịch thông minh (Smart Action Sidebar)</b>, theo dõi các cảnh báo khẩn cấp (như sắp hết hạn bảo hiểm).<br><img src='/api/v1/MediaFile/view-image/manuals/customer-care-step-3.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Điền mã code, tên chương trình, loại giảm giá (Theo phần trăm hoặc Số tiền cố định), giá trị và mức giảm tối đa.<br><img src='/api/v1/MediaFile/view-image/manuals/customer-voucher-step-2.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Sử dụng khung chat để tư vấn trực tiếp. Bạn có thể nhấn nút gửi mã Voucher khuyến mãi gợi ý để kích thích khách chốt đơn.<br><img src='/api/v1/MediaFile/view-image/manuals/customer-chat-step-3.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
