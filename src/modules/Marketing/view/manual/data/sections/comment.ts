  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Các bình luận có trạng thái <b>Chờ duyệt</b> cần được bạn xem xét trước khi hiển thị công khai.<br><img src='/api/v1/MediaFile/view-image/manuals/comment-manage-step-1.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
