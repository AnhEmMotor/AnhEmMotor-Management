  ...
  pages: [
    {
      ...
      steps: [
        ...
        "Sử dụng trình soạn thảo văn bản (Editor) để nhập nội dung. Bạn có thể định dạng chữ, chèn hình ảnh và liên kết.<br><img src='/api/v1/MediaFile/view-image/manuals/article-create-step-1.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
    ...
    },
    {
      ...
      steps: [
        ...
        "Sử dụng ô tìm kiếm phía trên để tìm bài viết theo tiêu đề, hoặc bộ lọc chuyên mục để khoanh vùng bài viết.<br><img src='/api/v1/MediaFile/view-image/manuals/article-list-step-2.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
