...
export const contactSection: GuideSection = {
  ...
  description: 'Quản lý các yêu cầu liên hệ, tư vấn từ khách hàng gửi qua form.',
  pages: [
    {
      id: 'contact-process',
      ...
      steps: [
        ...
        `Sau khi gọi điện hoặc gửi email phản hồi khách hàng, hãy cập nhật trạng thái từ <b>Chưa xử lý</b> sang <b>Đang xử lý</b> hoặc <b>Đã hoàn thành</b>.<br><img src='${formatImageUrl('api/v1/MediaFile/view-image/manuals/contact-process-step-2.webp')}' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />`,
