...
export const dashboardSection: GuideSection = {
  ...
  description:
    "Xem tổng quan thống kê và hiệu suất của các chiến dịch tiếp thị.",
  pages: [
    {
      ...
      steps: [
        ...
        "Xem các chỉ số tổng quan ở phía trên cùng để nắm bắt nhanh tình hình hoạt động của các chiến dịch.<br><img src='/api/v1/MediaFile/view-image/manuals/dashboard-overview-step-1.webp' style='max-width: 100%; border-radius: 8px; margin-top: 10px; border: 1px solid #eee;' />",
