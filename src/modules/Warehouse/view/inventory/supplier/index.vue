<template>
  <div class="resp-page flex flex-col gap-4 pb-5">
    ...
    <ElDialog v-model="dialogVisible" width="600px" append-to-body destroy-on-close>
      <template #header>
    ...
    <ElDialog v-model="restoreDialogVisible" width="800px" append-to-body>
      ...
      >
        ...
        <ElTableColumn prop="email" label="Email" min-width="150" show-overflow-tooltip />
...
import { useSupplierTable } from '@/views/inventory/supplier/hooks/useSupplierTable';
    ...
    steps: [
      {
        ...
        popover: {
          ...
          description: 'Khu vực này hiển thị các thông tin thống kê chung về các loại đối tác.',
          side: 'bottom',
          align: 'start',
        },
      },
