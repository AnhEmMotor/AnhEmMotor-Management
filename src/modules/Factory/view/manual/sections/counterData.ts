export const sectionData = {
  ...
  description: "Quản lý việc thu tiền và xuất hóa đơn cho khách hàng sau khi sửa chữa xong.",
  pages: [
    {
      id: "counter-payment",
      ...
      tips: ["Luôn kiểm tra chính xác số tiền khách hàng đưa và số tiền thối lại."]
    }
  ]
}
