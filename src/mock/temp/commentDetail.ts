...
export const commentList = ref<Comment[]>([
  {
    ...
    author: "trắngđêm",
    content:
      "đenthầnlờingộkhôngcủamởđấutrườngmặtthậtcủađốtnổrồi！kỳđợitrênđường！",
    ...
    replies: [
      {
        ...
        author: "sớmnắng",
        content:
          "cùngđảmtâma，nghenóicầncầnđếnthiểuRTX 3070mớinăngcaohiệuvậndòng。",
  ...
  },
  {
    ...
    author: "chuông",
    content:
      "130GBcủatồntrữcầncầucóđiểmkhoetờa，Khôngquahọachấtnàygìhảo，cũngtìnhcóCó thểnguyên。",
    ...
    replies: [
      {
        ...
        author: "vânđầu",
        content:
          "Chínhthựccóđiểmcao，Khôngquađểnàyloạisản phẩmchấtcủaduhí，giá trịđược。",
