        ...
        replies: [
          {
            id: 201,
            author: 'Nguyễn Văn Hùng',
            content: 'Cảm ơn shop nhé, dịch vụ hậu mãi và bảo hành ở đây rất tuyệt vời.',
    ...
    replies: [
      {
        id: 102,
        author: 'Vũ Quốc Việt',
        content: 'Làm rất kỹ nha bác, thợ tay nghề cao, kiểm tra tổng quát xe miễn phí nữa.',
        timestamp: '2024-09-04 10:20',
        replies: [
          {
            id: 202,
            author: 'Trần Minh Tâm',
            content: 'Cảm ơn bác nhé, mai em tranh thủ chạy qua làm luôn cho yên tâm.',
        ...
        replies: [
          {
            id: 203,
            author: 'Lê Thị Mai',
            content: 'Dạ SĐT em là 0987654321, nhờ shop gọi tư vấn giúp em nhé. Cảm ơn shop nhiều!',
...
export const commentList = ref<Comment[]>(saved ? JSON.parse(saved) : defaultComments);
