<template>
  <svg style="width: 24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <path d="M22 22L2 22" stroke="#ff0000" stroke-width="1.5" stroke-linecap="round"></path>
      <path
      ...
      <path
        ...
        stroke-linecap="round"
      ></path>
      <path d="M4 22V9.5" stroke="#ff0000" stroke-width="1.5" stroke-linecap="round"></path>
      <path d="M20 22V9.5" stroke="#ff0000" stroke-width="1.5" stroke-linecap="round"></path>
      <path
