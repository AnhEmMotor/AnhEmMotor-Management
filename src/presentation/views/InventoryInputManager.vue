...
const isVehicleWorkflow = ref(false)

const openNewInventoryModal = () => {
  isEditMode.value = false
  isVehicleWorkflow.value = false
...
const openNewVehicleInventoryModal = () => {
  isEditMode.value = false
  isVehicleWorkflow.value = true
  currentInventoryData.value = {
    supplier: null,
    model: null,
    costPrice: 0,
  ...
  <div class="p-4 sm:p-6 rounded-xl shadow-lg bg-white">
    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <Button
          v-if="hasPermission(Permissions.InputsCreate)"
          text="Nhập xe mới (Asset ID)"
          :icon="IconPlus"
          color="primary"
          @click="openNewVehicleInventoryModal"
        />
    ...
    <InventoryInputFormModal
      ...
      :is-vehicle-workflow="isVehicleWorkflow"
