...
const CustomerManager = () => import('@views/CustomerManagement.vue')
...
const DebtCommitmentManager = () => import('@views/DebtCommitmentManager.vue')
const NotFoundView = () => import('@views/NotFoundView.vue')
const HREmployees = () => import('@views/hr/Employees.vue')
const HRCommissionPolicy = () => import('@views/hr/CommissionPolicy.vue')
const HRPayroll = () => import('@views/hr/Payroll.vue')
const HRKPI = () => import('@views/hr/KPI.vue')
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'debt-commitment',
          path: 'debts',
          component: DebtCommitmentManager,
          meta: {
            requiresAuth: true,
            title: 'Công nợ & Cam kết',
            permission: Permissions.SuppliersView,
          },
        },
        {
        ...
        },
        {
          ...
          meta: {
            requiresAuth: true,
            title: 'Hồ sơ nhân sự',
            permission: Permissions.HRView,
          },
        },
        {
          name: 'hr-commission-policy',
          path: 'hr/commission-policy',
          component: HRCommissionPolicy,
          meta: {
            requiresAuth: true,
