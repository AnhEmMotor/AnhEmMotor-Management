        ...
        <div class="text-center py-8">
          <div class="flex justify-center mb-6">
            <div
              ...
              style="background-color: var(--el-color-info)"
            >
              <el-icon :size="48" color="white"><Cpu /></el-icon>
            </div>
          </div>
          ...
          <h2 class="text-3xl font-bold title tracking-tight mb-4">Lỗi máy chủ</h2>
          <p class="text-base subtitle px-6 mb-10">
            Xin lỗi, đã xảy ra lỗi trên máy chủ. Chúng tôi đang khắc phục sự cố. Vui lòng thử lại
            sau vài phút.
          </p>

          <div class="flex justify-center gap-4">
            <el-button size="large" @click="goBack" class="custom-btn">
...
import { Cpu, HomeFilled, Back } from '@element-plus/icons-vue';
