<template>
  <div
    class="error-page min-h-screen flex items-center justify-center bg-gray-50"
  >
    <div class="text-center">
      <h1 class="text-9xl font-bold text-gray-300">500</h1>
      <h2 class="mt-4 text-3xl font-bold text-gray-900">Lỗi máy chủ</h2>
      <p class="mt-4 text-gray-600 max-w-md mx-auto">
        Xin lỗi, đã xảy ra lỗi trên máy chủ. Chúng tôi đang khắc phục sự cố. Vui
        lòng thử lại sau vài phút.
      </p>
