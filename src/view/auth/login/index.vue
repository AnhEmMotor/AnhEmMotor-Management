        ...
        <div class="mt-8">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span
                class="px-2 bg-white dark:bg-gray-800 text-gray-500 subtitle rounded-full"
                style="background: var(--el-bg-color-overlay)"
              >
                Hoặc tiếp tục với
              </span>
            </div>
              ...
              >
                ...
                >
                  <GoogleLogin
                    ...
                    style="transform: scale(5); transform-origin: top left"
                  />
                </div>
              </div>
            </div>
